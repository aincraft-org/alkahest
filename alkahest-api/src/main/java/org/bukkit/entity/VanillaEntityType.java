...
/**
 * Vanilla Minecraft entity types. Implements {@link EntityType} so constants remain usable
 * as {@code EntityType.PIG} via static fields on the interface.
 *
 * <p>Prefer typing against {@link EntityType} so custom entity types can participate.
 */
public enum VanillaEntityType implements EntityType {
    ...
    private static final Map<String, VanillaEntityType> NAME_MAP = new HashMap<>();
    private static final Map<Short, VanillaEntityType> ID_MAP = new HashMap<>();

    static {
        for (VanillaEntityType type : values()) {
            if (type.name != null) {
    ...
    private VanillaEntityType(/*@Nullable*/ String name, /*@Nullable*/ Class<? extends Entity> clazz, int typeId) {
        this(name, clazz, typeId, true);
    }

    private VanillaEntityType(/*@Nullable*/ String name, /*@Nullable*/ Class<? extends Entity> clazz, int typeId, boolean independent) {
        this.name = name;
        this.clazz = clazz;
    ...
    @Contract("null -> null")
    @Nullable
    public static VanillaEntityType fromName(@Nullable String name) {
        if (name == null) {
            return null;
        }
    ...
    @Deprecated(since = "1.6.2", forRemoval = true)
    @Nullable
    public static VanillaEntityType fromId(int id) {
