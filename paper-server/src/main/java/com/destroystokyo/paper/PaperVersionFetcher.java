...
/**
 * Version fetcher for Alkahest, a private fork of Paper.
 *
 ...
 * and the startup/version-check messages explain that this is a private fork build.</p>
 */
...
public class PaperVersionFetcher implements VersionFetcher {
    ...
    private static final String FORK_DESCRIPTION = "Alkahest (private fork of Paper)";
    ...
    public Component getVersionMessage() {
        return text(FORK_DESCRIPTION + " - " + BUILD_INFO.asString(ServerBuildInfo.StringRepresentation.VERSION_SIMPLE));
    }

    public static void getUpdateStatusStartupMessage() {
        COMPONENT_LOGGER.info(text("*** " + FORK_DESCRIPTION + " ***"));
        COMPONENT_LOGGER.info(text("*** Running " + BUILD_INFO.asString(ServerBuildInfo.StringRepresentation.VERSION_FULL) + " ***"));
